...
\begin{enumerate}
\item[(1)] Let $X_1, \ldots, X_n \sim \Poiss(\lambda)$
and let $\hat\lambda = n^{-1}\sum_{i=1}^n X_i$. Find the $\bias$,
...
\item[(2)] Let $X_1,\ldots, X_n \sim \Unif(0,\theta)$ and let
$\hat\theta = \max\{X_1 , \ldots, X_n\}$. Find the
...
\item[(3)]
Let $X_1,\ldots,X_n \sim \Unif(0, \theta)$ and let $\hat\theta=2\overline{X_n}$.
